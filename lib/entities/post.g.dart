...
void _postEntitySerialize(
  ...
  writer.writeStringList(offsets[1], object.files);
...
PostEntity _postEntityDeserialize(
  ...
  final object = PostEntity(
    ...
    files: reader.readStringList(offsets[1]) ?? [],
...
extension PostEntityQueryFilter
  ...
  QueryBuilder<PostEntity, PostEntity, QAfterFilterCondition>
      filesElementContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'files',
        value: value,
  ...
  QueryBuilder<PostEntity, PostEntity, QAfterFilterCondition>
      filesElementMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'files',
        wildcard: pattern,
  ...
  QueryBuilder<PostEntity, PostEntity, QAfterFilterCondition> filesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'files',
        0,
...
extension PostEntityQueryWhereDistinct
  ...
  QueryBuilder<PostEntity, PostEntity, QDistinct> distinctByFiles() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'files');
    });
  }
...
extension PostEntityQueryProperty
  ...
  QueryBuilder<PostEntity, List<String>, QQueryOperations> filesProperty() {
    return QueryBuilder.apply(this, (query) {
